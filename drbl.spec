...
* Thu Sep 14 2017 Steven Shiau <steven _at_ nchc org tw> 2.25.11-drbl1
  * Improve the mechanism to get dns in drblpush.

* Wed Aug 02 2017 Steven Shiau <steven _at_ nchc org tw> 2.25.10-drbl1
...
* Mon Jul 10 2017 Steven Shiau <steven _at_ nchc org tw> 2.25.7-drbl1
  * Language file ca_ES was updated. Thanks to René Mérou.
...
* Tue Jun 20 2017 Steven Shiau <steven _at_ nchc org tw> 2.25.4-drbl1
...
* Tue Jun 13 2017 Steven Shiau <steven _at_ nchc org tw> 2.25.3-drbl1
  * Update language files about SMB versions.

* Mon Jun 12 2017 Steven Shiau <steven _at_ nchc org tw> 2.25.2-drbl1
  * Collected MAC address file with NIC device name not in the form eth*
    was not copied to /etc/drbl/ by drblpush.

* Mon Jun 12 2017 Steven Shiau <steven _at_ nchc org tw> 2.25.1-drbl1
  * Language file hu_HU was updated. Thanks to Greg Marki.
    Language file ja_JP.UTF-8 was updated. Thanks to Akira YOSHIYAMA.
    Language file tr_TR updated. Thanks to Volkan Gezer.
    Language file de_DE was updated. Thanks to Michael Vinzenz.
...
* Tue May 02 2017 Steven Shiau <steven _at_ nchc org tw> 2.24.8-drbl1
  * Update language files about wait command for ocs-onthefly.

* Sat Apr 29 2017 Steven Shiau <steven _at_ nchc org tw> 2.24.7-drbl1
...
* Sun Apr 23 2017 Steven Shiau <steven _at_ nchc org tw> 2.24.4-drbl1
  - Sort out the language files about lite server.

* Sat Apr 22 2017 Steven Shiau <steven _at_ nchc org tw> 2.24.3-drbl1
...
* Mon Apr 17 2017 Steven Shiau <steven _at_ nchc org tw> 2.23.34-drbl1
...
* Tue Feb 07 2017 Steven Shiau <steven _at_ nchc org tw> 2.23.20-drbl1
  - Suppress the tput error during booting in makeboot.sh and
    drbl-functions.
...
* Sun Jan 29 2017 Steven Shiau <steven _at_ nchc org tw> 2.23.15-drbl1
...
* Thu Oct 13 2016 Steven Shiau <steven _at_ nchc org tw> 2.21.8-drbl1
  - Add packages os-prober & dislocker for Clonezilla/DRBL live packages
    list.

* Sat Oct 01 2016 Steven Shiau <steven _at_ nchc org tw> 2.21.7-drbl1
  - Language file hu_HU was updated. Thanks to Greg Marki.
  - Language file ja_JP.UTF-8 was updated. Thanks to Akira YOSHIYAMA.
  - Language file de_DE was updated. Thanks to Michael Vinzenz.
  - Language file fr_FR was updated. Thanks to Jean-Francois Nifenecker.
...
* Mon Sep 19 2016 Steven Shiau <steven _at_ nchc org tw> 2.21.4-drbl1
  - Update language files. Thanks to Rafael Fontenelle for reporting this.
    Ref: https://sourceforge.net/p/clonezilla/bugs/263/

* Fri Sep 16 2016 Steven Shiau <steven _at_ nchc org tw> 2.21.3-drbl1
...
* Mon Jul 18 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.34-drbl1
...
* Thu Jul 07 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.31-drbl1
- Update language file zh_TW.UTF-8 for bind mount.

* Thu Jul 07 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.30-drbl1
...
* Tue May 17 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.10-drbl1
[Ceasar Sun]
- drbl-login-switch now supports the config for Xenial.

* Sun May 15 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.9-drbl1
- Add an option "-o" to drbl-sl so that different cases can be used.

* Sat May 14 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.8-drbl1
- Remove the option "--force-yes" of apt-get when installing required packages on Debian. It was for legacy Debian/Ubuntu.

* Sat May 14 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.7-drbl1
- install-kernel-for-client: avoid getting empty line for kernel version.

* Sat May 14 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.6-drbl1
...
* Tue May 10 2016 Steven Shiau <steven _at_ nchc org tw> 2.20.3-drbl1
...
* Mon Apr 04 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.16-drbl1
- Add support for Debian 7.10 and 8.4.

* Tue Mar 29 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.15-drbl1
...
* Mon Mar 07 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.11-drbl1
- Add client files for Ubuntu 15.10.

* Mon Mar 07 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.10-drbl1
- Add support for Debian 8.3.

* Mon Mar 07 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.9-drbl1
- Remove scientific linux i386 net install in drbl.conf since it does not exist.
- Fix typos in changelog.

* Sat Mar 05 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.8-drbl1
...
* Thu Feb 18 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.5-drbl1
- Update language files for the checksum results log file prompt.

* Wed Feb 17 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.4-drbl1
...
* Tue Feb 16 2016 Steven Shiau <steven _at_ nchc org tw> 2.19.3-drbl1
- Update language files for better description about checksum.
...
* Tue Nov 3 2015 Steven Shiau <steven _at_ nchc org tw> 2.17.12-drbl1
...
* Tue Sep 29 2015 Steven Shiau <steven _at_ nchc org tw> 2.17.3-drbl1
...
* Thu Aug 27 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.23-drbl1
...
* Mon Aug 24 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.22-drbl1
- Bug fixed: For Debian >=8 the file /var/lib/nfs/state was missing which caused rpc.statd failing to start in DRBL client.

* Thu Aug 20 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.21-drbl1
...
* Tue Aug 11 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.17-drbl1
- Language files were updated for the option "-k1", both GPT and MBR format are supported.

* Thu Jul 30 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.16-drbl1
...
* Sun May 24 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.9-drbl1
...
* Thu May 21 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.6-drbl1
...
* Mon May 18 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.2-drbl1
- drbl.conf: grub-efi-amd64-bin grub2-efi added in PKG_TO_QUERY.
- Suppress the findind error message in drbl-gen-grub-efi-nb.

* Mon May 18 2015 Steven Shiau <steven _at_ nchc org tw> 2.15.1-drbl1
...
* Fri May 15 2015 Steven Shiau <steven _at_ nchc org tw> 2.14.12-drbl1
...
* Mon May 04 2015 Steven Shiau <steven _at_ nchc org tw> 2.14.4-drbl1
...
* Sun Mar 29 2015 Steven Shiau <steven _at_ nchc org tw> 2.13.13-drbl1
...
* Mon Mar 23 2015 Steven Shiau <steven _at_ nchc org tw> 2.13.11-drbl1
...
* Thu Mar 05 2015 Steven Shiau <steven _at_ nchc org tw> 2.13.8-drbl1
- Some ecryptfs-related options from drbl-ocs.conf were moved to drbl-functions.

* Tue Feb 17 2015 Steven Shiau <steven _at_ nchc org tw> 2.13.7-drbl1
- Language file fr_FR was updated. Thanks to Jean-Francois Nifenecker.
...
* Mon Jan 12 2015 Steven Shiau <steven _at_ nchc org tw> 2.12.9-drbl1
...
* Mon Jan 05 2015 Steven Shiau <steven _at_ nchc org tw> 2.12.6-drbl1
- Language files were updated for converting encrypted/decrypted images.

* Sat Jan 03 2015 Steven Shiau <steven _at_ nchc org tw> 2.12.5-drbl1
...
* Thu Dec 25 2014 Steven Shiau <steven _at_ nchc org tw> 2.12.1-drbl1
...
* Wed Dec 10 2014 Steven Shiau <steven _at_ nchc org tw> 2.11.14-drbl1
- Now i586 instead of i486 Clonezilla live is in the stable release, therefore the corresponding changes were done.

* Mon Dec 08 2014 Steven Shiau <steven _at_ nchc org tw> 2.11.13-drbl1
- Language file ja_JP.UTF-8 was updated. Thanks to Akira YOSHIYAMA.
- Language file ca_ES was updated. Thanks to René Mérou.
...
* Fri Nov 28 2014 Steven Shiau <steven _at_ nchc org tw> 2.11.8-drbl1
- Adding support for CentOS 6.6.

* Thu Nov 27 2014 Steven Shiau <steven _at_ nchc org tw> 2.11.7-drbl1
...
* Mon Nov 10 2014 Steven Shiau <steven _at_ nchc org tw> 2.11.3-drbl1
...
* Mon Nov 10 2014 Steven Shiau <steven _at_ nchc org tw> 2.11.2-drbl1
...
* Sat Aug 16 2014 Steven Shiau <steven _at_ nchc org tw> 2.9.15-drbl1
- Adding firstboot.DBN7.6.drbl for updated Debian Wheezy.

* Sat Aug 16 2014 Steven Shiau <steven _at_ nchc org tw> 2.9.14-drbl1
- Adding package syslinux-util in PKG_TO_QUERY of drbl.conf.

* Sat Aug 16 2014 Steven Shiau <steven _at_ nchc org tw> 2.9.13-drbl1
...
* Thu Jun 26 2014 Steven Shiau <steven _at_ nchc org tw> 2.9.9-drbl1
- Language files sk_SK was updated. Thanks to Ondrej Dzivy Balucha.
- Language file ja_JP.UTF-8 was updated. Thanks to Akira YOSHIYAMA.
...
* Mon Jun 23 2014 Steven Shiau <steven _at_ nchc org tw> 2.9.7-drbl1
- Language file ca_ES was updated. Thanks to René Mérou.
- Language file it_IT was updated. Thanks to Gianfranco Gentili.
- Language file fr_FR was updated. Thanks to Jean-Francois Nifenecker.
...
* Sun Jun 01 2014 Steven Shiau <steven _at_ nchc org tw> 2.9.4-drbl1
...
* Sun Apr 27 2014 Steven Shiau <steven _at_ nchc org tw> 2.8.22-drbl1
- Adding modified halt and rc.sysinit for DRBL clients of CentOS 6.5.

* Sat Apr 26 2014 Steven Shiau <steven _at_ nchc org tw> 2.8.21-drbl1
...
* Wed Mar 05 2014 Steven Shiau <steven _at_ nchc org tw> 2.7.30-drbl1
...
* Tue Feb 18 2014 Steven Shiau <steven _at_ nchc org tw> 2.7.27-drbl1
...
* Thu Jan 09 2014 Steven Shiau <steven _at_ nchc org tw> 2.7.18-drbl1
- Language file it_IT was updated. Thanks to Gianfranco Gentili.
- Language file fr_FR was updated. Thanks to Jean-Francois Nifenecker.
- Language file de_DE was updated. Thanks to Michael Vinzenz.
- Language file ja_JP.UTF-8 was updated. Thanks to Akira YOSHIYAMA.
...
* Mon Dec 23 2013 Steven Shiau <steven _at_ nchc org tw> 2.7.14-drbl1
- Spanish language file was updated. Thanks to Juan Ramón Martínez <jrmc77 _at_ terra es>.

* Wed Dec 18 2013 Steven Shiau <steven _at_ nchc org tw> 2.7.13-drbl1
...
* Thu Dec 12 2013 Steven Shiau <steven _at_ nchc org tw> 2.7.9-drbl1
- One more sentence about ocs-cvtimg-comp was added in language files.

* Wed Dec 11 2013 Steven Shiau <steven _at_ nchc org tw> 2.7.8-drbl1
- One more sentence about ocs-cvtimg-comp was added in language files.

* Tue Dec 10 2013 Steven Shiau <steven _at_ nchc org tw> 2.7.7-drbl1
